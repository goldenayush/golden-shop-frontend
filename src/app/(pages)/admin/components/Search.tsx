...
export default function Search() {
   ...
   return (
      <div ref={wrapperRef} className="w-full md:w-[500px] lg:w-[552px] relative">
         ...
         {/* result container */}
         {show && (
            <div className="bg-[#202123] p-[20px] absolute w-full md:w-[500px] lg:w-[552px] mt-4 rounded-[4px]">
               {/* result */}
